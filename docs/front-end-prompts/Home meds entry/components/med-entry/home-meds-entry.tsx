...
export function HomeMedsEntry() {
  ...
  function handleMethodSelect(method: MedSource) {
    ...
    if (method === "manual") {
      ...
      // In production: open camera → Screen 5 flow
      alert("Camera would open here to scan a pill bottle.");
      ...
      >
        <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-4 py-3">
          <Button variant="outline" className="gap-2" size="sm">
            ...
            <span className="hidden sm:inline">Back to Discharge Meds</span>
          ...
          <Button className="gap-2" size="sm" disabled={meds.length === 0}>
            <span className="hidden sm:inline">Review Both Lists</span>
