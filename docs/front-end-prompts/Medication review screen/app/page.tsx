      ...
      <main className="mx-auto max-w-4xl px-4 py-6 space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <MedListColumn
            ...
            meds={DISCHARGE_MEDS}
            variant="discharge"
            onEdit={() => alert("Navigate back to Screen 3 — Discharge Meds")}
          />
          <MedListColumn
            title="Home Meds"
            meds={HOME_MEDS}
            variant="home"
            onEdit={() => alert("Navigate back to Screen 4 — Home Meds")}
          />
        </div>
        ...
        <div className="flex flex-col items-center gap-3 pt-1">
          ...
          >
            {screen === "reviewing" ? null : screen === "analyzing" ? (
              <>
          ...
          {/* Secondary back link */}
          <button
            onClick={() => alert("Navigate back to Screen 4 — Home Meds")}
